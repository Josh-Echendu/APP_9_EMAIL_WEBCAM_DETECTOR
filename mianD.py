...
while True:
    ...
    for contour in contours:
        ...
        # if it notices a an object through the rectangle it calls the function 
        if rectangle.any():
            status = 1 # if it notice a an object the status variable is updated to '1'
